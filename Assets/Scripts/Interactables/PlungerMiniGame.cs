...
public class PlungerMiniGame : MonoBehaviour, IInteractable
{
    ...
    private void Update()
    {
        ...
        if (splashParticles != null)
        {
            ...
            splashParticles.SetActive(isInStruggleZone);
        }
    ...
    private IEnumerator MountAndStartSequence()
    {
        ...
        AudioManager.instance.PlayOneShot(FMODEvents.instance.PlayerToilet, transform.position);
